...
public class StudentRegisterTest {
    ...
    public void testAddStudentTwice()
   {
       try
       {
           register.addStudent(new Student(6, "Ching", "Shi"));
           register.addStudent(new Student(6, "Ching", "Shi"));
       }
       catch (Exception ex)
       {
    ...
    public void testFindStudentsByName()
    {
        ...
        {
            register.addStudent(new Student(5, "gayan", "chamara"));
            register.addStudent(new Student(6, "Ching", "gayan"));
            register.addStudent(new Student(7, "Ching", "Shi"));
            register.addStudent(new Student(8, "gayan", "Shi"));
        }
        catch (Exception ex)
        {
            Assert.fail("Adding student failed");
        ...
        expected.add(register.findStudent(5));
