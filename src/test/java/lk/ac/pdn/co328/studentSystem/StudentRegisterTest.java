   ...
   @Test
    public void testAddStudentTwice() {
       ...
       try {
           ...
           register.addStudent(new Student(1, "nimal", "kumara"));
           Assert.fail("Adding student twice should generate an exception");

       }catch (Exception ex){
           System.out.println("Add student twice pass");
       }
    ...
    public void testReset() {
        ...
        register.reset();
        Assert.assertNull("student data was not reseted",register.findStudent(1));
        Assert.assertNull("student data was not reseted",register.findStudent(2));
