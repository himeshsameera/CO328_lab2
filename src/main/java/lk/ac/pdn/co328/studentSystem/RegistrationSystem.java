...
public class RegistrationSystem
{
    ...
    private static void  searchStudentByName(){
        System.out.println("Enter any part of the name !");
        String name;
        ...
        try {
           students = register.findStudentsByName(name);
            ...
            System.out.println("Error in searching students : "+ e.getMessage());
        }

    }
    private static void cleanStudentregistry(){
        register.reset();
    }
}
