...
public class StudentRegister {
    private static Exception duplicateStudentIdException;

    private ArrayList<Student> studentList = new ArrayList<Student>();

    public static Exception getDuplicateStudentIdException() {
        return duplicateStudentIdException;
    }
    ...
    public void addStudent(Student st) throws Exception {
        for (Student student : studentList) {
            if (student.getId() == st.getId()) {
                duplicateStudentIdException = new Exception("StudentID already exists in the register");
                throw duplicateStudentIdException;
            }
        }
        studentList.add(st);
    }
